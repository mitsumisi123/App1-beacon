...
public class UpdateStatusService extends Service {
    ...
    private void postUpdateStatus(String identifier, String acceleration, String temperature) {
        StatusModel statusModel = new StatusModel(acceleration,temperature, AppPreferences.getInstance(getApplicationContext()).getDeviceName());
            ...
            public void onTelemetriesFound(List<EstimoteTelemetry> telemetries) {
                ...
                if(telemetries.size() > 0) {
                    ...
                    for(EstimoteTelemetry telemetry :telemetries){
                        ...
                        postUpdateStatus(device_id,accelerometer,telemetry.temperature.toString());
